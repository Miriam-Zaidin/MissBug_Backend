...
async function query(filterBy = {}, sortBy = {}) {
    ...
    try {
        ...
        //     usersToReturn = usersToReturn.filter(user => regExp.test(user.title + user.description))
        // }
        // if (filterBy.severity) {
        //     usersToReturn = usersToReturn.filter(user => user.severity === filterBy.severity)
        // }
        // if (filterBy.labels) {
        //     usersToReturn = usersToReturn
        //         .filter(user => user.labels?.some(label => filterBy.labels.includes(label)))
        // }
        // if (sortBy.sortField) {
        //     usersToReturn = usersToReturn
        //         .sort((a, b) => {
